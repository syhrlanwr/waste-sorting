...
@section('content')
    {{-- <div class="container">
        <div class="flex justify-center">
            <div class="card shadow-lg bg-neutral text-default w-1/2">
              <div class="card-body">
                <div class="card-title">MASUKKAN DATA WARGA</div>
    ...
    <div class="h-screen flex justify-center items-center">
        <div class="card w-full bg-neutral text-neutral-content">
            <div class="card-body items-center text-start">
                ...
                <form method="POST" action="{{ route('citizen.data') }}" class="flex flex-col px-4 py-6 space-y-3 w-full">
                    @csrf
                    @method('PUT')
                    <div>
